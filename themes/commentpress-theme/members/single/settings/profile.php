	...
	<div id="content">
		<div class="padder">
			...
			<div id="item-body" role="main">
				...
				<h3><?php _e( 'Profile Settings', 'commentpress-core' ); ?></h3>
				...
				<form action="<?php echo trailingslashit( bp_displayed_user_domain() . bp_get_settings_slug() . '/profile' ); ?>" method="post" class="standard-form" id="settings-form">
								...
								<table class="profile-settings" id="xprofile-settings-<?php bp_the_profile_group_slug(); ?>">
									<thead>
										<tr>
											...
											<th class="title"><?php _e( 'Visibility', 'commentpress-core' ); ?></th>
										</tr>
									</thead>
					...
					<div class="submit">
						<input id="submit" type="submit" name="xprofile-settings-submit" value="<?php esc_attr_e( 'Save Settings', 'commentpress-core' ); ?>" class="auto" />
					</div>

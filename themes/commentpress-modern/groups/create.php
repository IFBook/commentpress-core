			...
			<div class="item-body" id="group-create-body">
				...
				<?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
					...
					<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
						...
						<div class="main-column">
							...
							<p><?php _e( 'To skip the avatar upload process, hit the "Next Step" button.', 'commentpress-core' ); ?></p>
						</div><!-- .main-column -->
					...
					<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
						...
						<h3><?php _e( 'Crop Group Avatar', 'commentpress-core' ); ?></h3>
				...
				<?php if ( bp_is_group_creation_step( 'group-invites' ) ) : ?>
					...
					<?php if ( bp_is_active( 'friends' ) && bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
						...
						<div class="main-column">
							...
							<div id="message" class="info">
								<p><?php _e('Select people to invite from your friends list.', 'commentpress-core'); ?></p>
							</div>
							...
							<?php if ( bp_group_has_invites() ) : ?>
								...
								<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
									...
									<li id="<?php bp_group_invite_item_id(); ?>">
										...
										<div class="action">
											<a class="remove" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php _e( 'Remove Invite', 'commentpress-core' ); ?></a>
										</div>
									</li>
					...
					<?php else : ?>
						...
						<div id="message" class="info">
							<p><?php _e( 'Once you have built up friend connections you will be able to invite others to your group. You can send invites any time in the future by selecting the "Send Invites" option when viewing your new group.', 'commentpress-core' ); ?></p>
						</div>
				...
				<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
					...
					<div class="submit" id="previous-next">
						...
						<?php if ( !bp_is_first_group_creation_step() ) : ?>
							...
							<input type="button" value="<?php _e( 'Back to Previous Step', 'commentpress-core' ); ?>" id="group-creation-previous" name="previous" onclick="location.href='<?php bp_group_creation_previous_link(); ?>'" />
						...
						<?php if ( !bp_is_last_group_creation_step() && !bp_is_first_group_creation_step() ) : ?>
							...
							<input type="submit" value="<?php _e( 'Next Step', 'commentpress-core' ); ?>" id="group-creation-next" name="save" />
						...
						<?php if ( bp_is_first_group_creation_step() ) : ?>
							...
							<input type="submit" value="<?php _e( 'Create Group and Continue', 'commentpress-core' ); ?>" id="group-creation-create" name="save" />
						...
						<?php if ( bp_is_last_group_creation_step() ) : ?>
							...
							<input type="submit" value="<?php _e( 'Finish', 'commentpress-core' ); ?>" id="group-creation-finish" name="save" />

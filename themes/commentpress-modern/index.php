...
<?php if (have_posts()) : ?>
	...
	<div class="search_result">
		...
		<p class="search_meta"><?php the_tags(_e( 'Tags: ', 'commentpress-core' ), ', ', '<br />'); ?> <?php _e( 'Posted in', 'commentpress-core' ); ?> <?php the_category(', ') ?> | <?php edit_post_link(_e( 'Edit', 'commentpress-core' ), '', ' | '); ?>  <?php comments_popup_link(_e( 'No Comments &#187;', 'commentpress-core' ), _e( '1 Comment &#187;', 'commentpress-core' ), _e( '% Comments &#187;', 'commentpress-core' )); ?></p>

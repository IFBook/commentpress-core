				...
				<?php if ( have_posts() ) : ?>
					...
					<?php while ( have_posts() ) : ?>
						...
						<div id="post-<?php the_ID(); ?>" class="post image_attachment">
							...
							<h2 class="post_title"><a href="<?php echo esc_url( get_permalink( $post->post_parent ) ); ?>" rev="attachment" title="<?php esc_attr_e( 'Back to gallery', 'commentpress-core' ); ?>"><?php echo esc_html( get_the_title( $post->post_parent ) ); ?></a> <span><a href="<?php the_permalink(); ?>" class="attachment_permalink" title="<?php esc_attr_e( 'Permalink for this image', 'commentpress-core' ); ?>"><?php the_title(); ?></a></span></h2>
							...
							<div class="the_image_attachment">
								...
								<p class="image_attachment_wrap"><a class="image_attachment_link" href="<?php echo esc_url( wp_get_attachment_url( $post->ID ) ); ?>"><?php echo wp_get_attachment_image( $post->ID, 'large' ); ?></a></p>

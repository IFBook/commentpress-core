...
if ( ! function_exists( 'commentpress_get_featured_comments_page_content' ) ):
/** 
 * @description: featured comments page display function
 * @todo: 
 *
 */
function commentpress_get_featured_comments_page_content() {
	...
	$pagetitle = apply_filters( 
		'cp_page_all_comments_title', 
		__( 'Featured Comments', 'commentpress-core' )
	);
	...
	// get data
	$_data = commentpress_get_featured_comments_content( $page_or_post );

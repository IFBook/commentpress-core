...
2. Download and Network Activate my fork of "BuddyPress Groupblog" on GitHub (which fixes a number of bugs) from [https://github.com/christianwach/bp-groupblog](https://github.com/christianwach/bp-groupblog)

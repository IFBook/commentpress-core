...
class CommentPress_Core_Display {
	...
	public function get_jquery() {
		...
		wp_enqueue_script(
			'jquery_commentpress',
			plugins_url( 'includes/commentpress-core/assets/js/jquery.commentpress' . $debug_state . '.js', COMMENTPRESS_PLUGIN_FILE ),
		...
		wp_enqueue_script(
			'jquery_scrollto',
			plugins_url( 'includes/commentpress-core/assets/js/jquery.scrollTo.js', COMMENTPRESS_PLUGIN_FILE ),
			[ 'jquery_commentpress' ],
			COMMENTPRESS_VERSION, // Version.
			false // In footer.
		);
		...
		wp_enqueue_script(
			'jquery_cookie',
			plugins_url( 'includes/commentpress-core/assets/js/jquery.biscuit.js', COMMENTPRESS_PLUGIN_FILE ),
			[ 'jquery_commentpress' ],
			COMMENTPRESS_VERSION, // Version.
			false // In footer.
		);
	...
	public function get_text_highlighter() {
		...
		if ( ! $this->core->db->is_touch() || ( defined( 'COMMENTPRESS_TOUCH_SELECT' ) && COMMENTPRESS_TOUCH_SELECT ) ) {
			...
			wp_enqueue_script(
				...
				plugins_url( 'includes/commentpress-core/assets/js/jquery.wrap-selection' . $debug_state . '.js', COMMENTPRESS_PLUGIN_FILE ),
				[ 'jquery_commentpress' ],
				COMMENTPRESS_VERSION, // Version.
				false // In footer.
			);
			...
			wp_enqueue_script(
				'jquery_highlighter',
				plugins_url( 'includes/commentpress-core/assets/js/jquery.highlighter' . $debug_state . '.js', COMMENTPRESS_PLUGIN_FILE ),
				[ 'jquery_wrapselection' ],
				COMMENTPRESS_VERSION, // Version.
				false // In footer.
			);
			...
			wp_enqueue_script(
				...
				plugins_url( 'includes/commentpress-core/assets/js/jquery.texthighlighter' . $debug_state . '.js', COMMENTPRESS_PLUGIN_FILE ),
				[ 'jquery_highlighter' ],
				COMMENTPRESS_VERSION, // Version.
				false // In footer.
			);
	...
	public function get_custom_quicktags() {
		...
		wp_enqueue_script(
			...
			plugins_url( 'includes/commentpress-core/assets/js/cp_quicktags_3.3.js', COMMENTPRESS_PLUGIN_FILE ),
			[ 'quicktags' ],
			COMMENTPRESS_VERSION, // Version.
			true // In footer.
		);

...
<tr valign="top">
	...
	<td>
		<select id="<?php echo esc_attr( $this->key_editor ); ?>" name="<?php echo esc_attr( $this->key_editor ); ?>">
			<option value="1" <?php echo ( ( '1' == $editor ) ? ' selected="selected"' : '' ); ?>><?php esc_html_e( 'Rich-text Editor', 'commentpress-core' ); ?></option>
			<option value="0" <?php echo ( ( '0' == $editor ) ? ' selected="selected"' : '' ); ?>><?php esc_html_e( 'Plain-text Editor', 'commentpress-core' ); ?></option>
		</select>
	</td>
</tr>
...
<tr valign="top">
	...
	<td>
		<select id="<?php echo esc_attr( $this->key_promote ); ?>" name="<?php echo esc_attr( $this->key_promote ); ?>">
			<option value="1" <?php echo ( ( '1' == $promote ) ? ' selected="selected"' : '' ); ?>><?php esc_html_e( 'Promote reading', 'commentpress-core' ); ?></option>
			<option value="0" <?php echo ( ( '0' == $promote ) ? ' selected="selected"' : '' ); ?>><?php esc_html_e( 'Promote commenting', 'commentpress-core' ); ?></option>
		</select>

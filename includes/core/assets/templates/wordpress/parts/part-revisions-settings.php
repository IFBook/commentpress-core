...
<tr valign="top">
	...
	<td>
		<select id="<?php echo esc_attr( $this->key_revisions ); ?>" name="<?php echo esc_attr( $this->key_revisions ); ?>">
			<option value="y" <?php echo ( 'y' === $revisions ? ' selected="selected"' : '' ); ?>><?php esc_html_e( 'Enabled', 'commentpress-core' ); ?></option>
			<option value="n" <?php echo ( 'n' === $revisions ? ' selected="selected"' : '' ); ?>><?php esc_html_e( 'Disabled', 'commentpress-core' ); ?></option>
		</select>

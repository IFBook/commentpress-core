...
?>
<!-- <?php echo esc_html( $this->parts_path ); ?>part-revisions-settings.php -->
<tr valign="top">
	<th scope="row">
	...
	<td>
		<select id="<?php echo esc_attr( $this->key_revisions ); ?>" name="<?php echo esc_attr( $this->key_revisions ); ?>">
			<option value="y" <?php selected( $revisions, 'y' ); ?>><?php esc_html_e( 'Enabled', 'commentpress-core' ); ?></option>
			<option value="n" <?php selected( $revisions, 'n' ); ?>><?php esc_html_e( 'Disabled', 'commentpress-core' ); ?></option>
		</select>

...
?>
<!-- <?php echo esc_html( $this->parts_path ); ?>part-parser-settings.php -->
...
<tr valign="top">
	...
	<td>
		<select id="<?php echo esc_attr( $this->key_do_not_parse ); ?>" name="<?php echo esc_attr( $this->key_do_not_parse ); ?>">
			<option value="y" <?php selected( $do_not_parse, 'y' ); ?>><?php esc_html_e( 'Yes', 'commentpress-core' ); ?></option>
			<option value="n" <?php selected( $do_not_parse, 'n' ); ?>><?php esc_html_e( 'No', 'commentpress-core' ); ?></option>
		</select>

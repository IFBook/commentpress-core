...
?>
<!-- <?php echo esc_html( $this->parts_path ); ?>part-sites-settings-core.php -->
<tr valign="top">
	<th scope="row">
		<label for="<?php echo esc_attr( $this->key_disable ); ?>"><?php esc_html_e( 'Disable CommentPress on this Site', 'commentpress-core' ); ?></label>
	</th>
	<td>
		<input id="<?php echo esc_attr( $this->key_disable ); ?>" name="<?php echo esc_attr( $this->key_disable ); ?>" value="1" type="checkbox" />
